...
Here are two visualizations of how many coins in the dataset there are for each condition level, to put the previous plot even more into context: Note: The rating system for coin condition, starting at Near Fine, is this: Near Fine -\> Fine -\> Near VF -\> Very Fine (VF) -\> Near XF -\> XF (Extremely Fine) -\> Choice XF -\> AU
...
This predictor performs most effectively between \$60 and \$500, other values may be unreliable. Likewise, certain other characteristics of coins are underrepresented in the dataset— for example, electrum coins— and thus the price predictions may not be accurate. It is also important to note that all of these coins feature the eagle prominently, and thus this model cannot be generalized to standard ancient coins.
